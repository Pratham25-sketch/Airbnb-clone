//nodemon database.js krne pr ye sara data insert ho jaega Listing model mein
const Listing=require("./models/listings.js");
const mongoose=require("mongoose");
main()
  .then(() => {
    console.log("connection successful to listing database");
  })
...
await Listing.insertMany([
...

  {
    ...
    filters: ["Trending", "Swimming Pools"]
  },
  {
  ...
  },
  {
    ...
    filters: ["Trending", "Rooms", "Iconic Cities"]
  },
  {
    ...
    location: "Verbier",
    country: "Switzerland",
    geometry: { type: "Point", coordinates: [7.2300, 46.0969] },
    filters: ["Mountains", "Arctic"]
  },
  {
  ...
  },
  {
    ...
    filters: ["Trending", "Swimming Pools", "Arctic"]
  },
  {
  ...
  },
  {
    ...
    image: {
      ...
      filename: "boston_brownstone"
    },
    price: 2200,
    location: "Boston",
    country: "United States",
    geometry: { type: "Point", coordinates: [-71.0589, 42.3601] },
    filters: ["Iconic Cities"]
  },
  {
    ...
    image: {
      ...
      filename: "bali_bungalow"
    },
    price: 1800,
    location: "Bali",
    country: "Indonesia",
    geometry: { type: "Point", coordinates: [115.1889, -8.4095] },
    filters: ["Swimming Pools", "Trending"]
  },
  {
  ...
  },
  {
    ...
    image: {
      ...
      filename: "charleston_cottage"
    },
    price: 1600,
    location: "Charleston",
    country: "United States",
    geometry: { type: "Point", coordinates: [-79.9311, 32.7765] },
    filters: ["Iconic Cities", "Rooms"]
  },
  {
  ...
  },
  {
    ...
    country: "United States",
    geometry: { type: "Point", coordinates: [-106.8175, 39.1911] },
    filters: ["Trending", "Swimming Pools", "Arctic","Farms"]
  },
  {
    ...
    image: {
      ...
      filename: "costarica_beachhouse"
    },
    price: 1800,
    location: "Costa Rica",
    country: "Costa Rica",
    geometry: { type: "Point", coordinates: [-84.0907, 9.7489] },
    filters: ["Trending", "Swimming Pools", "Arctic","Camping"]
  }
